...
local groups = {
  ...
  Folded                    = { bg = "#edeacd", fg = "#a3a194", bold = true },
  ...
  -- Priority is too high, fallthrough to Treesitter captures.
  ["@lsp.type.comment.lua"] = {},
}

vim.hl.priorities["@string.special.url"] = 126

vim.opt.background = "light"

vim.cmd.highlight("clear")
vim.g.colors_name = "mu"
